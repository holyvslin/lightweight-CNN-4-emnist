...
def extract_and_save_mnist(file_path,save_dir):
  ...
  with gzip.GzipFile(fileobj=f) as bytestream:
    ...
    for index,d in enumerate(data):
        ...
        imges = Image.fromarray(numpy.transpose(d)).convert('L')
...
def main():
    ...
    TEST_IMAGES_PATH = 'data/emnist/emnist-balanced-test-images-idx3-ubyte.gz'
    extract_and_save_mnist(TEST_IMAGES_PATH,"./TT_test_img")
