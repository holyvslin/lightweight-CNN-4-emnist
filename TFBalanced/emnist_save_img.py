...
img_file =  r'./data/emnist/emnist-balanced-test-images-idx3-ubyte.gz'  #  Path to your xxx-images-idx3-ubyte
label_file = r'./data/emnist/emnist-balanced-test-labels-idx1-ubyte.gz'  # Path to your xxx-labels-idx1-ubyte
generate_img_root = r"./test_img"    # Path to save the images
...
print "generate_img_root", generate_img_root
